...
#
# 默认取 2026-07-27 ~ 2026-08-02 —— 那是一次买量投放的高峰期，7 天里有
...
#
# 用法：
#   SRC_DB=betogo FROM_DATE=2026-07-27 TO_DATE=2026-08-02 USERS=800 \
...
FROM_DATE="${FROM_DATE:-2026-07-27}"
TO_DATE="${TO_DATE:-2026-08-02}"
USERS="${USERS:-800}"
