...
KEY=/Volumes/MacAPFS/TMA_FILES/aliyun.pem
...
# 清理 KYC / OTP Redis 缓存
for pattern in 'tma:kyc:*' 'kyc:otp:*' 'kyc:otp:sent:*' 'kyc:otp:lock:*' 'kyc:rl:*' 'kyc:idlock:*' 'kyc:fail:*' 'auth:forgot:*' 'auth:login:*' 'sms:daily:*'; do
