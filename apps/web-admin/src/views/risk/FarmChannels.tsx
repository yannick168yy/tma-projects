      ...
      >
        <Table
          ...
          columns={[
            ...
            { title: '累计彩金', dataIndex: 'bonusTotal', align: 'right', render: (v: number | null) => v == null ? '-' : `₱${v.toFixed(2)}` },
            { title: '净充值', dataIndex: 'netDeposit', align: 'right', render: (v: number | null) => v == null ? '-' : `₱${v.toFixed(2)}` },
