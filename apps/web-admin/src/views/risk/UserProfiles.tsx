    ...
    <Card title="用户风险画像">
      ...
      <Table
        ...
        columns={[
          ...
          { title: '彩金', dataIndex: 'bonusTotal', render: (v: number) => `₱${v.toFixed(2)}` },
          { title: '净充值', dataIndex: 'netDeposit', render: (v: number) => `₱${v.toFixed(2)}` },
      ...
      >
        {detail?.signal && (
          <Descriptions bordered size="small" column={2} style={{ marginBottom: 16 }}>
            ...
            <Descriptions.Item label="累计彩金">₱{detail.signal.bonusTotal.toFixed(2)}</Descriptions.Item>
            <Descriptions.Item label="累计充值">₱{detail.signal.netDeposit.toFixed(2)}</Descriptions.Item>
