  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/tenants', label: '租户与连接池', roles: ['super_admin'] },
...
function getDefaultOpenKeys(pathname: string): string[] {
  ...
  if (['/audit-log', '/settings', '/system-params', '/site-domains', '/tenants', '/sms-test', '/db-backup'].some((p) => pathname.startsWith(p))) return ['system']
  return []
}
