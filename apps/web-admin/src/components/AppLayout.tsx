  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/self-service', label: '自助配置', roles: ['super_admin', 'finance'] },
...
function getDefaultOpenKeys(pathname: string): string[] {
  ...
  if (['/audit-log', '/settings', '/system-params', '/site-domains', '/bottom-nav', '/platform-billing', '/self-service', '/sms-test', '/db-backup'].some((p) => pathname.startsWith(p))) return ['system']
  return []
}
