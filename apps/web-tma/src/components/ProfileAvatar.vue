<template>
  <div
    class="w-10 h-10 rounded-xl overflow-hidden shadow-md"
  ...
  >
    <svg viewBox="0 0 40 40" width="40" height="40" aria-hidden="true">
      ...
      <path d="M17.5 28.5 Q20 30.5 22.5 28.5" stroke="#78350f" stroke-width="1.1" fill="none" stroke-linecap="round" />
