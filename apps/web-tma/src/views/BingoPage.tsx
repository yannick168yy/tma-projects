      ...
      <div className="mt-6">
        <div className="flex items-center justify-between mb-3 px-4">
          ...
          <div className="flex items-center gap-2">
            <button type="button" className="h-6 px-2 flex items-center rounded-full bg-secondary text-primary text-[10px] font-bold active:scale-90 transition-transform" onClick={() => onOpenCategoryLobby({ title: '🇵🇭 All Pinoy Games', siteCategory: 'perya' })}>{t('common.viewAll')}</button>
            <div className="flex items-center gap-0.5">
