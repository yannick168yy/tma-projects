...
import TarsierAvatar from '@/components/home/TarsierAvatar.vue'
    ...
    <div class="relative bg-background w-full max-w-[430px] min-h-screen flex flex-col overflow-hidden">
      ...
      <header class="relative flex-shrink-0">
        <div class="flex items-center px-4 pt-5 pb-4 gap-3">
          <div class="flex-shrink-0 leading-none flex flex-col items-start gap-0.5">
            <div class="flex items-baseline">
              <span class="text-white font-black leading-none tracking-tight font-display text-xl">
                TARSIER
              </span>
              <span class="text-primary font-black leading-none tracking-tight font-display text-xl">
                WIN
              </span>
            </div>
          </div>
          ...
          <button type="button" class="flex-shrink-0 relative">
            <div
              class="w-10 h-10 rounded-xl overflow-hidden shadow-md shadow-amber-500/20"
        ...
        <template v-if="walletOpen">
          ...
          <div
            class="absolute left-4 right-4 top-full -mt-1 z-50 bg-card border border-border rounded-2xl shadow-2xl overflow-hidden"
          >
            <div class="p-4">
              ...
              <div class="flex items-center justify-between py-2.5 border-b border-border">
                ...
                <span class="text-emerald-400 font-black text-base">
              ...
              <div class="flex items-center justify-between py-2.5">
                ...
                <span class="text-violet-400 font-black text-base">
            ...
            <div class="flex gap-2 px-4 pb-4">
              <button
                type="button"
                class="flex-1 py-2 rounded-xl bg-secondary text-muted-foreground text-xs font-bold hover:text-foreground transition-colors"
              ...
              <button
                type="button"
                class="flex-1 py-2 rounded-xl bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center gap-1.5 hover:bg-yellow-400 transition-colors"
      ...
      <div class="flex-1 overflow-y-auto overflow-x-hidden pb-20 hide-scrollbar">
        ...
        <div class="flex items-center gap-2 px-4 mt-4 overflow-x-auto hide-scrollbar">
          <button type="button" class="flex-shrink-0 w-9 h-9 rounded-xl bg-secondary flex items-center justify-center">
        ...
        <section class="mt-6">
          <div class="flex items-center justify-between px-4 mb-3">
            <div class="flex items-center gap-2">
              ...
              <span class="bg-violet-500/20 text-violet-300 text-[10px] font-bold px-2 py-0.5 rounded-full">
                FEATURED
              </span>
            </div>
