export default {
  ...
  wallet: {
    ...
    depositGuideSubtitleMax: '你现在的余额是免费彩金，只能用来玩游戏。存入自己的钱即可随时提现，首充还立送最高 {{max}}',
    depositGuideSubtitle: '你现在的余额是免费彩金，只能用来玩游戏。存入自己的钱即可随时提现',
    ...
    bonusLockedHint: '未解锁彩金 {{locked}} 暂不可提，当前可提现 {{amount}}',
