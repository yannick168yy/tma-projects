export default {
  ...
  home: {
    ...
    advFast: '极速提现',
    advSupport: '7×24 人工客服',
    advLicensed: '持牌合规 · 安全保障',
    communitySection: '加入官方社群',
    brandIntroTitle: '欢迎来到 BetoGo',
    brandIntroBody: 'BetoGo 是持有 PAGCOR 牌照的一线游戏平台，汇集 JILI、PG Soft、Pragmatic Play 等世界级厂商的数千款精品老虎机、真人娱乐场、捕鱼与爆点游戏，全部集成在一个流畅、安全的 App 中。充值即时到账，提现极速，客服全天候在线——随时随地，尽情畅玩。',
    brandStatGames: '游戏',
    brandStatProviders: '厂商',
    brandStatInstant: '即时',
    brandStatPayouts: '到账',
    brandStatSupport: '客服',
    licenseTitle: '官方牌照与责任博彩',
