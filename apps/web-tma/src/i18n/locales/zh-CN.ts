export default {
  ...
  pwa: {
    promptTitle: '安装 BETOGO 应用',
    promptDesc: '把 BETOGO 添加到主屏幕——一键直达、全屏游戏、秒开加载。',
    promptInstall: '添加到主屏幕',
    promptMore: '了解更多',
    promptLater: '暂不',
    iosStep1: '点击 Safari 底部的「分享」按钮',
    iosStep2: '下滑找到并点击「添加到主屏幕」',
    iosStep3: '点击「添加」，BETOGO 出现在主屏幕',
    ...
    dl: {
      ...
      ios: 'iPhone / iPad',
      androidCta: '下载 APK',
      androidComingSoon: 'APK 即将上线——请先用下方「添加到主屏幕」',
      pwaCta: '添加到主屏幕',
      pwaInstalled: '已安装——请从主屏幕打开',
      whyTitle: '为什么要安装？',
      why1Title: '一键直达',
      why1Desc: '像原生 App 一样从主屏幕启动',
      why2Title: '全屏体验',
      why2Desc: '没有浏览器地址栏，纯全屏游戏',
      why3Title: '加载更快',
      why3Desc: '秒开启动，比浏览器更流畅',
      androidStepsTitle: '安卓安装步骤',
      androidStep1: '点击上方「添加到主屏幕」',
      androidStep2: '在弹窗中确认「安装」',
      androidStep3: '从主屏幕打开 BETOGO',
      iosStepsTitle: 'iPhone / iPad 安装步骤',
      openInSafariHint: '请在 Safari 中打开本页以完成 iOS 安装。',
    },
  },
}
