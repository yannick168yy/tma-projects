export default {
  ...
  wallet: {
    ...
    depositGuideTitle: 'Deposit untuk membuka penarikan',
    depositGuideTitleMax: 'Bonus hingga {{max}} untuk deposit pertama!',
    depositGuideSubtitle: 'Bonus langsung masuk — deposit Anda tetap bisa ditarik',
