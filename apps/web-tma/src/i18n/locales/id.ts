export default {
  ...
  wallet: {
    ...
    depositGuideSubtitleMax: 'Saldo Anda adalah bonus gratis — hanya untuk bermain. Deposit uang Anda sendiri untuk menarik kapan saja, plus gratis hingga {{max}} di deposit pertama',
    depositGuideSubtitle: 'Saldo Anda adalah bonus gratis — hanya untuk bermain. Deposit uang Anda sendiri untuk menarik kapan saja',
    ...
    bonusLockedHint: 'Bonus terkunci {{locked}} belum bisa ditarik — bisa ditarik: {{amount}}',
