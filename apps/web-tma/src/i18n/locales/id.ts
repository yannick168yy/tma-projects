export default {
  ...
  wallet: {
    ...
    depositGuideTitle: 'Ingin menarik dana? Deposit dulu',
    depositGuideSubtitleMax: 'Saldo Anda saat ini adalah bonus untuk bermain. Dana yang Anda deposit bisa ditarik kapan saja — plus gratis hingga {{max}} untuk deposit pertama',
    depositGuideSubtitle: 'Saldo Anda saat ini adalah bonus untuk bermain. Dana yang Anda deposit bisa ditarik kapan saja',
