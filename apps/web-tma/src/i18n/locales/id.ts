export default {
  errors: {
    ...
    depositRequiredBeforeWithdraw: 'Silakan lakukan deposit uang asli pertama sebelum menarik dana. Deposit USDT/USDC minimal 5.',
    bonusLocked: 'Jumlah melebihi saldo yang dapat ditarik (sebagian saldo adalah bonus terkunci)',
  ...
  home: {
    ...
    maintenanceNotice: 'Platform game sedang dalam pemeliharaan & peningkatan, diperkirakan pulih pukul 13:00 hari ini. Semua game sementara tidak dapat diakses — mohon maaf atas ketidaknyamanannya.',
    ...
    communitySubtitle: 'Ikuti kanal resmi kami untuk bonus eksklusif, giveaway, dan event terbaru.',
    ...
    responsibleNote: 'Perjudian bisa menimbulkan kecanduan, ketahui kapan harus berhenti. Perjudian tidak menjamin penghasilan atau perbaikan kondisi keuangan — bermainlah sesuai batas Anda.',
    infoDetails: {
      terms: {
  ...
  profile: {
    ...
    footerLegal: 'BetoGo beroperasi dengan lisensi valid. Bermainlah dengan bijak.',
    links: {
  ...
  wallet: {
    title: 'DOMPET SAYA',
    rejectReasons: {
      generic: 'Penarikan ditolak. Silakan hubungi dukungan untuk detailnya.',
      wagering: 'Selesaikan syarat taruhan yang diperlukan sebelum menarik dana.',
      largeAmount: 'Jumlah penarikan ini memerlukan peninjauan tambahan. Silakan hubungi dukungan.',
      winnings: 'Kemenangan Anda baru-baru ini memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      gameplay: 'Aktivitas permainan Anda baru-baru ini memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      shortGameplay: 'Aktivitas permainan jangka pendek Anda baru-baru ini memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      depositRequired: 'Diperlukan deposit berhasil yang memenuhi syarat sebelum penarikan.',
      firstDeposit: 'Selesaikan deposit berhasil yang memenuhi syarat sebelum penarikan pertama Anda.',
      accountMismatch: 'Informasi akun penarikan tidak cocok dengan detail terverifikasi Anda.',
      accountLinked: 'Akun penarikan ini sudah tertaut dengan akun lain.',
      invalidChannel: 'Informasi saluran atau alamat penarikan tidak valid. Silakan periksa dan kirim ulang.',
      wageringLegacy: 'Persyaratan taruhan belum selesai.',
      relationship: 'Informasi hubungan akun Anda memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      ipDevice: 'Penarikan Anda ditolak karena akun Anda berbagi alamat IP atau perangkat yang sama dengan akun lain.',
      bonusWagering: 'Selesaikan syarat taruhan bonus yang diperlukan sebelum menarik dana.',
      rewardRecords: 'Catatan hadiah Anda memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      betRecords: 'Catatan taruhan Anda memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      accountReward: 'Catatan hadiah akun Anda memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      transactionVerify: 'Permintaan penarikan Anda memerlukan verifikasi transaksi. Silakan hubungi dukungan.',
      bonusActivity: 'Aktivitas bonus Anda baru-baru ini memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      cancelledBets: 'Catatan taruhan yang dibatalkan memerlukan verifikasi tambahan sebelum penarikan. Silakan hubungi dukungan.',
      securityReview: 'Permintaan penarikan Anda tidak lolos tinjauan keamanan akun. Silakan hubungi dukungan.',
      nameMatch: 'Nama pada akun penarikan Anda cocok dengan akun terdaftar lain. Silakan hubungi dukungan untuk memverifikasi identitas Anda.',
    },
    deposit: 'Deposit',
    withdraw: 'Tarik',
    history: 'Riwayat',
    ...
    regularRedepHint: 'Klaim {{amount}} segera setelah deposit berhasil masuk.',
    regularRedepTitle: 'Bonus Isi Ulang',
    regularRedepCryptoDesc: 'Pilih nominal {{currency}} dan kirim jumlah yang sama. Bonus dapat diklaim setelah masuk.',
    limitedOfferCta: 'Deposit Sekarang',
    limitedOfferLater: 'Nanti saja',
    cryptoFirstDepTitle: 'Bonus deposit pertama aktif',
    cryptoFirstDepSubtitle: 'Pilih jumlah {{currency}}, lalu kirim jumlah yang sama dari wallet Anda.',
    cryptoFirstDepAmount: 'Jumlah {{currency}}',
    cryptoFirstDepExpected: 'Perkiraan masuk',
    cryptoFirstDepNext: '{{amount}} membuka +{{bonus}}',
    ...
    paymentPendingHelp: 'Selesaikan pembayaran di aplikasi yang terbuka. Jika tidak terbuka dengan benar, buka ulang atau salin tautan pembayaran di bawah.',
    reopenPayment: 'Buka Ulang Pembayaran',
    copyPaymentLink: 'Salin Tautan',
    paymentLinkCopied: 'Disalin',
    ...
    matrixWithdrawFailed: 'Penarikan gagal. Silakan coba lagi.',
    ...
    turnoverPromo: 'Bonus',
    turnoverFeatureBonus: 'Bonus Slot',
    ...
    promoAppdl: 'Bonus Unduh App',
    promoTask: 'Hadiah Tugas',
    promoRedep: 'Bonus Isi Ulang',
    depositGuideTitle: 'Deposit uang asli, tarik uang asli',
    depositGuideSubtitleMax: 'Saldo Anda adalah bonus gratis — hanya untuk bermain. Deposit uang asli untuk membuka penarikan, plus gratis hingga {{max}} di deposit pertama',
    depositGuideSubtitle: 'Saldo Anda adalah bonus gratis — hanya untuk bermain. Deposit uang asli untuk membuka penarikan',
    depositGuideCta: 'Deposit Sekarang',
    depositGuideRules: 'Ketentuan bonus',
    guideRuleNeedTurnover: 'perlu taruhan {{required}} untuk menjadi tunai',
    guideRuleDeposit: 'Deposit hanya perlu taruhan 1x untuk ditarik',
    guideRuleCryptoMinDeposit: 'Deposit USDT/USDC minimal 5 untuk membuka penarikan',
    guideRuleFirstdep: 'Bonus deposit pertama hanya perlu taruhan {{x}}x',
  ...
  cs: {
    ...
    ticket: {
      entry: 'Tiket',
      title: 'Tiket Saya',
      subtitle: 'Tiket dukungan dan balasan agen yang tersimpan',
    ...
    status: {
      active: 'Ditangani AI',
      escalated: 'Menunggu agen',
      humanTaken: 'Ditangani agen',
      resolved: 'Selesai',
      closed: 'Ditutup',
    },
  },
  kyc: {
    ...
    docPassport: 'Paspor',
    docDriversLicense: 'Surat Izin Mengemudi',
    docPhilid: 'PhilID (Kartu Identitas Filipina)',
    docUmid: 'UMID',
    docAcrIcard: 'ACR I-Card',
    docKtp: 'KTP (Kartu Tanda Penduduk)',
    docSim: 'SIM (Surat Izin Mengemudi)',
    docType: {
      passport: 'Paspor',
      drivers_license: 'Surat Izin Mengemudi',
      philid: 'PhilID (Kartu Identitas Filipina)',
      umid: 'UMID',
      ...
      nrega_job_card: 'Kartu kerja NREGA / MGNREGA',
      npr_letter: 'Surat / kartu NPR',
    },
    match: 'Cocokkan',
    matched: 'Cocok',
    ...
    errors: {
      ...
      otpRequired: 'Verifikasi SMS diperlukan',
