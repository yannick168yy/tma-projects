export default {
  checkin: {
    ...
    milestoneSubtitle: 'More streaks, bigger rewards!',
    yourSpins: 'Your Spins',
    thisWeek: 'This Week',
    claimShort: 'Claim',
    streakResetHint: 'Miss a day and your streak will reset.',
    daysWord: 'Days',
    ctaCheckin: 'Check in & Get Spin',
    ...
    entryCta: 'Check in',
    cardReward: 'FREE',
    cardRewardLabel: 'Daily Spins',
    cardBadge: 'No Deposit',
    cardStep1: 'Open Bonuses and tap Check in every day',
    cardStep2: 'Earn free Lucky Wheel spins — longer streaks unlock bigger rewards',
    floatLabel: 'Check-in',
  ...
  errors: {
    ...
    depositRequiredBeforeWithdraw: 'Please make your first real deposit before withdrawing. USDT/USDC deposits must be at least 5.',
    bonusLocked: 'Amount exceeds withdrawable balance (part of your balance is locked bonus)',
    ...
    invalidWithdrawAccount: 'Invalid withdrawal account number',
    withdrawPhoneMismatch: 'Withdrawals can only be sent to your own registered phone number',
    withdrawPhoneTaken: 'This phone number belongs to another account and cannot be used for withdrawal',
    minWithdrawal: 'Minimum withdrawal ₱{{value}}',
    withdrawBelowMin: 'Below the minimum withdrawal of {{value}}',
    withdrawAboveMax: 'Above the maximum withdrawal of {{value}}',
    withdrawAmountMustExceedGas: 'Withdrawal amount must be greater than the gas fee',
  ...
  cs: {
    ...
    ticket: {
      entry: 'Ticket',
      title: 'My Tickets',
      subtitle: 'Saved support tickets and agent replies',
    ...
    status: {
      active: 'AI handling',
      escalated: 'Waiting for agent',
      humanTaken: 'Agent handling',
      resolved: 'Resolved',
      closed: 'Closed',
    },
    orders: {
  ...
  kyc: {
    ...
    bindPhoneCta: 'Bind phone number',
    ...
    docType: {
      ...
      ktp: 'KTP (Indonesian identity card)',
      sim: 'SIM (Indonesian driving licence)',
      aadhaar: 'Aadhaar',
      voter_id: 'Voter ID (EPIC)',
      nrega_job_card: 'NREGA / MGNREGA job card',
      npr_letter: 'NPR letter / card',
    },
    ...
    redoDocEntry: 'Keep failing? The ID photo itself may be the problem — re-upload your ID',
    redoDocChoiceHint: 'Your current ID has passed verification. Upload a clearer ID photo, or continue to face verification.',
    redoDocContinueFace: 'Continue to face verification',
    ...
    errors: {
      ...
      otpRequired: 'SMS verification is required',
  ...
  home: {
    ...
    maintenanceNotice: 'Game platform under maintenance & upgrade, expected back by 13:00 today. All games are temporarily unavailable — sorry for any inconvenience.',
    ...
    communitySubtitle: 'Follow our official channels for exclusive bonuses, giveaways and the latest events.',
  ...
  tasks: {
    ...
    item: {
      ...
      daily_bets: { title: 'Place {{n}} Bets Today', subtitle: 'Valid bets count · resets daily', subtitleWithMin: 'Min {{amount}} per bet counts · resets daily' },
      ...
      agg_trial: { title: 'Claim Newbie Bonus', subtitle: 'One tap to claim — no deposit needed' },
    ...
    footer: {
      ...
      note4: '{{brandName}} reserves the right of final interpretation for all task rewards.',
    },
  },
  cashback: {
    ...
    footNote4: '{{brandName}} reserves the right of final interpretation for this program.',
  ...
  lossRebate: {
    ...
    introBody: 'Win or lose, we have your back. Each day we total your net loss on eligible games and hand back {{rate}}% as a bonus — every VIP level, no upper limit.',
    howTitle: 'How it works',
    how1: 'Net loss = your total bets minus total wins on eligible games that day.',
    how2: 'Rebate = net loss × {{rate}}%, with no cap.',
    how3: 'Calculated automatically once a day, for the previous day.',
    gamesTitle: 'Eligible games',
    gamesBody: 'Slots and Fishing games qualify. Live Casino and Sports betting are excluded.',
    condTitle: 'Conditions',
    cond1: 'Deposit at least {{min}} in total over the last {{days}} days to qualify (no same-day deposit needed).',
    cond2: 'The rebate base is capped at your deposits for that day.',
    ...
    status: {
      ...
      remaining: 'Est. rebate pending settlement',
      claimedToday: 'Claimed today',
      pendingSettle: "This is today's rebate accrued but not yet settled; it becomes claimable after the next settlement. See records for what you've already claimed.",
      settledAll: "Today's rebate is fully settled — check your records.",
    },
  ...
  bonuses: {
    ...
    newPlayer: {
      ...
      appdlDesc: 'Install {{brandName}} on your home screen, open the app and claim inside.',
    ...
    promos: {
      appdl: {
        ...
        desc: 'Install the {{brandName}} app or add it to your home screen, then open it and claim ₱{{amount}} for free — exclusive to app users!',
        badge: 'App Only',
        cta: 'Install Now',
        ctaClaim: 'Claim ₱{{amount}}',
        ctaClaimed: 'Claimed',
      ...
      trial: {
        ...
        firstdepTeaser: 'Plus a first-deposit bonus up to ₱{{max}} after claiming',
        claimedTitle: '₱{{amount}} credited!',
        claimedSub: 'Your free bonus is in your balance — start playing anytime.',
        firstdepOfferTitle: 'First deposit bonus: up to ₱{{max}}',
        firstdepOfferLine: 'Deposit ₱{{dep}}, get ₱{{total}} — the more you deposit, the bigger the bonus',
        goDeposit: 'Deposit & Get Bonus',
  ...
  wallet: {
    title: 'MY WALLET',
    rejectReasons: {
      generic: 'Withdrawal rejected. Please contact support for details.',
      wagering: 'Please complete the required wagering before submitting a withdrawal.',
      largeAmount: 'This withdrawal amount requires additional review. Please contact support for assistance.',
      winnings: 'Your recent winnings require additional verification before withdrawal. Please contact support.',
      gameplay: 'Your recent gameplay activity requires additional verification before withdrawal. Please contact support.',
      shortGameplay: 'Your recent short-term gameplay activity requires additional verification before withdrawal. Please contact support.',
      depositRequired: 'A qualifying successful deposit is required before withdrawal.',
      firstDeposit: 'Please complete a qualifying successful deposit before your first withdrawal.',
      accountMismatch: 'Withdrawal account information does not match your verified details.',
      accountLinked: 'This withdrawal account is already linked to another account.',
      invalidChannel: 'Withdrawal channel or address information is invalid. Please check and submit again.',
      wageringLegacy: 'Wagering requirements are not completed yet.',
      relationship: 'Your account relationship information requires additional verification before withdrawal. Please contact support.',
      ipDevice: 'Your withdrawal was rejected because your account shares the same IP address or device with other accounts.',
      bonusWagering: 'Please complete the required bonus wagering before submitting a withdrawal.',
      rewardRecords: 'Your reward records require additional verification before withdrawal. Please contact support.',
      betRecords: 'Your bet records require additional verification before withdrawal. Please contact support.',
      accountReward: 'Your account reward records require additional verification before withdrawal. Please contact support.',
      transactionVerify: 'Your withdrawal request requires transaction verification. Please contact support.',
      bonusActivity: 'Your recent bonus activity requires additional verification before withdrawal. Please contact support.',
      cancelledBets: 'Your cancelled bet records require additional verification before withdrawal. Please contact support.',
      securityReview: 'Your withdrawal request did not pass account security review. Please contact support.',
      nameMatch: 'The name on your withdrawal account matches another registered account. Please contact support to verify your identity.',
    },
    deposit: 'Deposit',
    withdraw: 'Withdraw',
    history: 'History',
    ...
    regularRedepHint: 'Claim {{amount}} as soon as your deposit is credited.',
    regularRedepTitle: 'Reload Bonus',
    regularRedepCryptoDesc: 'Choose a {{currency}} tier and send the same amount. Claim the bonus once credited.',
    limitedOfferCta: 'Deposit Now',
    limitedOfferLater: 'Maybe later',
    cryptoFirstDepTitle: 'First deposit bonus is active',
    cryptoFirstDepSubtitle: 'Choose a {{currency}} amount below, then send the same amount from your wallet.',
    cryptoFirstDepAmount: '{{currency}} amount',
    cryptoFirstDepExpected: 'Expected credit',
    cryptoFirstDepNext: '{{amount}} unlocks +{{bonus}}',
    ...
    paymentPendingHelp: 'Complete the payment in the opened app. If it did not open correctly, reopen or copy the payment link below.',
    ...
    turnoverPromo: 'Bonus',
    turnoverFeatureBonus: 'Slot Bonus',
    ...
    promoAppdl: 'App Download Bonus',
    promoTask: 'Task Reward',
    promoRedep: 'Reload Bonus',
    depositGuideTitle: 'Real money in, real money out',
    depositGuideSubtitleMax: 'Your balance is free bonus — for playing only. Deposit real money to enable withdrawals, plus get up to {{max}} FREE on your first deposit',
    depositGuideSubtitle: 'Your balance is free bonus — for playing only. Deposit real money to enable withdrawals',
    depositGuideCta: 'Deposit Now',
    depositGuideRules: 'Bonus terms',
    guideRuleNeedTurnover: 'requires {{required}} wagering to convert to cash',
    guideRuleDeposit: 'Deposits need only 1x wagering to withdraw',
    guideRuleCryptoMinDeposit: 'USDT/USDC deposits must be at least 5 to unlock withdrawals',
    guideRuleFirstdep: 'First deposit bonus needs only {{x}}x wagering',
