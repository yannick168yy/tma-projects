export default {
  ...
  wallet: {
    ...
    depositGuideTitle: 'Deposit to unlock withdrawals',
    depositGuideTitleMax: 'Get up to {{max}} FREE on your first deposit',
    depositGuideSubtitle: 'Bonus credited instantly — your deposit stays yours to withdraw',
