export default {
  ...
  pwa: {
    promptTitle: 'Get the BETOGO App',
    promptDesc: 'Add BETOGO to your home screen — one-tap access, full-screen play, instant loading.',
    promptInstall: 'Add to Home Screen',
    promptMore: 'Learn more',
    promptLater: 'Not now',
    iosStep1: 'Tap the Share button in Safari',
    iosStep2: 'Scroll and tap "Add to Home Screen"',
    iosStep3: 'Tap "Add" — BETOGO appears on your home screen',
    ...
    dl: {
      ...
      androidComingSoon: 'APK coming soon — use Add to Home Screen below',
      pwaCta: 'Add to Home Screen',
      pwaInstalled: 'Already installed — open from your home screen',
      whyTitle: 'Why install?',
      why1Title: 'One-tap access',
      why1Desc: 'Launch from your home screen like a native app',
      why2Title: 'Full-screen experience',
      why2Desc: 'No browser bars — pure full-screen gaming',
      why3Title: 'Faster loading',
      why3Desc: 'Starts instantly, smoother than the browser',
      androidStepsTitle: 'Install on Android',
      androidStep1: 'Tap "Add to Home Screen" above',
      androidStep2: 'Confirm "Install" in the popup',
      androidStep3: 'Open BETOGO from your home screen',
      iosStepsTitle: 'Install on iPhone / iPad',
      openInSafariHint: 'Open this page in Safari to install on iOS.',
    },
  },
}
