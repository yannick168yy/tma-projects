export default {
  ...
  wallet: {
    ...
    depositGuideTitle: 'Want to withdraw? Make a deposit first',
    depositGuideSubtitleMax: 'Your current balance is bonus credit for play only. Money you deposit can be withdrawn anytime — plus up to {{max}} FREE on your first deposit',
    depositGuideSubtitle: 'Your current balance is bonus credit for play only. Money you deposit can be withdrawn anytime',
    ...
    bonusLockedHint: 'Locked bonus {{locked}} not withdrawable yet — withdrawable now: {{amount}}',
