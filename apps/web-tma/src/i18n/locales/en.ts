export default {
  ...
  kyc: {
    ...
    redoDocConfirmHint: 'Your ID has already passed verification. Re-uploading means it will be reviewed again. Continue?',
    redoDocConfirm: 'Re-upload ID',
    redoDocCancel: 'Cancel',
