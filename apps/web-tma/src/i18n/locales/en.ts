export default {
  ...
  wallet: {
    ...
    depositGuideSubtitleMax: 'Your balance is free bonus — for playing only. Deposit your own money to withdraw anytime, plus get up to {{max}} FREE on your first deposit',
    depositGuideSubtitle: 'Your balance is free bonus — for playing only. Deposit your own money to withdraw anytime',
