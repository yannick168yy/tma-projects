export default {
  ...
  wallet: {
    ...
    depositGuideSubtitleMax: 'Số dư của bạn là thưởng miễn phí — chỉ để chơi. Nạp tiền của riêng bạn để rút bất cứ lúc nào, tặng thêm đến {{max}} cho lần nạp đầu',
    depositGuideSubtitle: 'Số dư của bạn là thưởng miễn phí — chỉ để chơi. Nạp tiền của riêng bạn để rút bất cứ lúc nào',
    ...
    bonusLockedHint: 'Thưởng khóa {{locked}} chưa thể rút — có thể rút: {{amount}}',
