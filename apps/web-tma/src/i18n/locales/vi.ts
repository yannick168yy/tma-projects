export default {
  errors: {
    ...
    depositRequiredBeforeWithdraw: 'Vui lòng nạp tiền thật lần đầu trước khi rút. Nạp USDT/USDC tối thiểu 5.',
    bonusLocked: 'Số tiền vượt quá số dư có thể rút (một phần là thưởng chưa mở khóa)',
    ...
    invalidWithdrawAccount: 'Số tài khoản rút tiền không hợp lệ',
    withdrawPhoneMismatch: 'Chỉ có thể rút về số điện thoại đã đăng ký của chính bạn',
    withdrawPhoneTaken: 'Số điện thoại này thuộc về tài khoản khác, không thể dùng để rút tiền',
    ...
    withdrawAmountMustExceedGas: 'Số tiền rút phải lớn hơn phí gas',
  ...
  bonuses: {
    ...
    promos: {
      trial: {
        ...
        firstdepTeaser: 'Nhận xong còn có thưởng nạp đầu lên tới ₱{{max}}',
        claimedTitle: 'Đã cộng ₱{{amount}}!',
        claimedSub: 'Thưởng miễn phí đã vào số dư — chơi ngay bất cứ lúc nào.',
        firstdepOfferTitle: 'Thưởng nạp lần đầu: lên tới ₱{{max}}',
        firstdepOfferLine: 'Nạp ₱{{dep}}, nhận ₱{{total}} — nạp càng nhiều thưởng càng lớn',
        goDeposit: 'Nạp ngay nhận thưởng',
        playFirst: 'Chơi trước',
      },
      firstdep: {
        tag: 'NẠP LẦN ĐẦU',
    ...
    disclaimer:
      'Mọi khuyến mãi tuân theo Điều khoản & Điều kiện BetoGo. Yêu cầu cược áp dụng.',
  },
  redpacket: {
  ...
  profile: {
    ...
    footerLegal: 'BetoGo hoạt động theo giấy phép hợp lệ. Chơi có trách nhiệm.',
    links: {
  ...
  wallet: {
    title: 'VÍ CỦA TÔI',
    rejectReasons: {
      generic: 'Yêu cầu rút tiền bị từ chối. Vui lòng liên hệ hỗ trợ để biết chi tiết.',
      wagering: 'Vui lòng hoàn thành vòng cược yêu cầu trước khi rút tiền.',
      largeAmount: 'Số tiền rút này cần được xem xét thêm. Vui lòng liên hệ hỗ trợ.',
      winnings: 'Khoản thắng gần đây của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      gameplay: 'Hoạt động chơi game gần đây của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      shortGameplay: 'Hoạt động chơi game ngắn hạn gần đây của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      depositRequired: 'Cần có một khoản nạp tiền thành công hợp lệ trước khi rút tiền.',
      firstDeposit: 'Vui lòng hoàn thành một khoản nạp tiền thành công hợp lệ trước lần rút đầu tiên.',
      accountMismatch: 'Thông tin tài khoản rút tiền không khớp với thông tin đã xác minh của bạn.',
      accountLinked: 'Tài khoản rút tiền này đã được liên kết với một tài khoản khác.',
      invalidChannel: 'Thông tin kênh hoặc địa chỉ rút tiền không hợp lệ. Vui lòng kiểm tra và gửi lại.',
      wageringLegacy: 'Yêu cầu vòng cược chưa được hoàn thành.',
      relationship: 'Thông tin mối quan hệ tài khoản của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      ipDevice: 'Yêu cầu rút tiền của bạn bị từ chối vì tài khoản của bạn dùng chung địa chỉ IP hoặc thiết bị với tài khoản khác.',
      bonusWagering: 'Vui lòng hoàn thành vòng cược thưởng yêu cầu trước khi rút tiền.',
      rewardRecords: 'Hồ sơ phần thưởng của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      betRecords: 'Hồ sơ đặt cược của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      accountReward: 'Hồ sơ phần thưởng tài khoản của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      transactionVerify: 'Yêu cầu rút tiền của bạn cần xác minh giao dịch. Vui lòng liên hệ hỗ trợ.',
      bonusActivity: 'Hoạt động thưởng gần đây của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      cancelledBets: 'Hồ sơ cược đã hủy của bạn cần xác minh thêm trước khi rút. Vui lòng liên hệ hỗ trợ.',
      securityReview: 'Yêu cầu rút tiền của bạn không vượt qua kiểm tra bảo mật tài khoản. Vui lòng liên hệ hỗ trợ.',
      nameMatch: 'Tên trên tài khoản rút tiền của bạn trùng với một tài khoản đã đăng ký khác. Vui lòng liên hệ hỗ trợ để xác minh danh tính.',
    },
    deposit: 'Nạp',
    withdraw: 'Rút',
    history: 'Lịch sử',
    ...
    regularRedepHint: 'Nhận {{amount}} ngay sau khi tiền nạp được ghi có.',
    regularRedepTitle: 'Thưởng Nạp Lại',
    regularRedepCryptoDesc: 'Chọn mức {{currency}} và gửi đúng số tiền. Có thể nhận thưởng sau khi ghi có.',
    limitedOfferCta: 'Nạp ngay',
    limitedOfferLater: 'Để sau',
    cryptoFirstDepTitle: 'Thưởng nạp lần đầu đang bật',
    cryptoFirstDepSubtitle: 'Chọn số {{currency}}, rồi gửi đúng số đó từ ví của bạn.',
    cryptoFirstDepAmount: 'Số {{currency}}',
    cryptoFirstDepExpected: 'Dự kiến ghi có',
    cryptoFirstDepNext: '{{amount}} mở khóa +{{bonus}}',
    ...
    paymentPendingHelp: 'Hoàn tất thanh toán trong ứng dụng đã mở. Nếu không mở đúng, hãy mở lại hoặc sao chép liên kết thanh toán bên dưới.',
    reopenPayment: 'Mở Lại Thanh Toán',
    copyPaymentLink: 'Sao Chép Liên Kết',
    paymentLinkCopied: 'Đã Sao Chép',
    ...
    matrixWithdrawFailed: 'Rút tiền thất bại. Vui lòng thử lại.',
    trustSsl: 'Mã hóa SSL',
    ...
    turnoverFeatureBonus: 'Thưởng slot',
    ...
    promoAppdl: 'Thưởng Tải App',
    promoTask: 'Thưởng Nhiệm Vụ',
    promoRedep: 'Thưởng Nạp Lại',
    depositGuideTitle: 'Nạp tiền thật, rút tiền thật',
    depositGuideSubtitleMax: 'Số dư của bạn là thưởng miễn phí — chỉ để chơi. Nạp tiền thật để mở rút tiền, tặng thêm đến {{max}} cho lần nạp đầu',
    depositGuideSubtitle: 'Số dư của bạn là thưởng miễn phí — chỉ để chơi. Nạp tiền thật để mở rút tiền',
    depositGuideCta: 'Nạp Ngay',
    depositGuideRules: 'Điều khoản khuyến mãi',
    guideRuleNeedTurnover: 'cần {{required}} doanh số cược để chuyển thành tiền mặt',
    guideRuleDeposit: 'Tiền nạp chỉ cần 1x doanh số cược để rút',
    guideRuleCryptoMinDeposit: 'Nạp USDT/USDC tối thiểu 5 để mở rút tiền',
    guideRuleFirstdep: 'Thưởng nạp đầu chỉ cần {{x}}x doanh số cược',
  ...
  referralPromo: {
    ...
    bindPhoneCta: 'Liên kết số điện thoại',
    copy: 'Sao chép',
    copied: 'Đã sao chép',
  ...
  cs: {
    ...
    ticket: {
      ...
      subtitle: 'Ticket hỗ trợ và phản hồi từ nhân viên đã lưu',
    ...
    status: {
      ...
      humanTaken: 'Nhân viên đang xử lý',
  ...
  kyc: {
    ...
    docType: {
      ...
      philid: 'PhilID (Căn cước Philippines)',
      umid: 'UMID',
      acr_icard: 'ACR I-Card',
      ktp: 'KTP (Căn cước Indonesia)',
      sim: 'SIM (Bằng lái Indonesia)',
      aadhaar: 'Aadhaar',
      voter_id: 'Thẻ cử tri (EPIC)',
      nrega_job_card: 'Thẻ việc làm NREGA / MGNREGA',
      npr_letter: 'Thư / thẻ NPR',
    },
    match: 'Khớp',
    matched: 'Đã khớp',
