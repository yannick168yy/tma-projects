export default {
  ...
  wallet: {
    ...
    depositGuideTitle: 'Muốn rút tiền? Hãy nạp trước',
    depositGuideSubtitleMax: 'Số dư hiện tại là thưởng chỉ để chơi. Tiền bạn nạp có thể rút bất cứ lúc nào — tặng thêm đến {{max}} cho lần nạp đầu',
    depositGuideSubtitle: 'Số dư hiện tại là thưởng chỉ để chơi. Tiền bạn nạp có thể rút bất cứ lúc nào',
