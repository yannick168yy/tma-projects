...
const schema = z.object({
  ...
  MARKET_DOMAIN_MAP: z.string()
    .default('{"betogo666.com":"PH","betogo777.com":"PH","betogo.ph":"PH","betogo.xyz":"ID","betogo.vip":"ID","betogo888.com":"ID","betogo.cc":"ID","betogo.games":"PUBLIC","betogo.app":"PUBLIC"}')
    .transform((value) => value.trim() || '{"betogo666.com":"PH","betogo777.com":"PH","betogo.ph":"PH","betogo.xyz":"ID","betogo.vip":"ID","betogo888.com":"ID","betogo.cc":"ID","betogo.games":"PUBLIC","betogo.app":"PUBLIC"}'),
