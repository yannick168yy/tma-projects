...
export function createAdminRouter(): Router {
  ...
  for (const r of [dashboardRoutes, usersRoutes, depositsRoutes, withdrawalsRoutes, auditRoutes, gamesRoutes, settingsRoutes, csRoutes, betOrdersRoutes, sgSettlementRoutes]) {
