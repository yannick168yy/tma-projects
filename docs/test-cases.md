...
| ADM-023 | 服务商余额与记账 | 手动刷新拉真实余额（YFPay/UnisPay）；代收=充值 paid、代付=提现 completed 聚合正确 | P1 | 🤖 |
...
| SEC-004 | webhook 来源伪造 | 568win seamless / YFPay / UnisPay / TG Stars 回调伪造签名全部被拒 | P0 | 🤖 |
