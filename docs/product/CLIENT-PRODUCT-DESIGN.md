...
5. **负责任披露**：18+、博彩风险提示、流水规则在提现/红包页可读。
...
- 顶栏头像、Promo 红点承担「我的 / 活动」入口；**不设独立 Casino Tab**（首页即大厅）。
...
| 菜单 | 邀请、红包记录、KYC、消息、语言、客服、责任博彩、关于 |
| 版本 | App 版本号 |
